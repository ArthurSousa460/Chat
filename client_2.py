...
class Client():
    ...
    def conection(self):
        ...
        trhead_1 = threading.Thread(target=self.send_menssage, args=[sock])
        trhead_2 = threading.Thread(target=self.receive_menssage, args=[sock])
...
client = Client('127.0.0.1', 58604, 'Arthur')
client.conection()
client.send_menssage()